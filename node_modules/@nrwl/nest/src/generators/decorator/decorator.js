...
function decoratorGenerator(tree, rawOptions) {
    ...
    return utils_1.runNestSchematic(tree, 'decorator', options);
}
exports.decoratorGenerator = decoratorGenerator;
exports.default = decoratorGenerator;
exports.decoratorSchematic = devkit_1.convertNxGenerator(decoratorGenerator);
function normalizeDecoratorOptions(tree, options) {
    return Object.assign(Object.assign({}, utils_1.normalizeOptions(tree, options)), { language: options.language });
}
