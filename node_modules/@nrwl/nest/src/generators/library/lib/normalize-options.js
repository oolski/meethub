...
exports.toNodeLibraryGeneratorOptions = exports.normalizeOptions = void 0;
...
function toNodeLibraryGeneratorOptions(options) {
    return {
        name: options.name,
...
exports.toNodeLibraryGeneratorOptions = toNodeLibraryGeneratorOptions;
